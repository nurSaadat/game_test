export class CollectionScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.totalEligible = 5; // 3 at location 1, 2 at location 2
  ...
  _showLocation(loc) {
    ...
    const points = loc === 1 ? this.loc1Points : this.loc2Points;
    this.activePoints = points;

    if (loc === 1) this._drawBackground1();
    else this._drawBackground2();
    ...
    const locLabel = loc === 1 ? "Location 1/2 — Residential Property" : "Location 2/2 — Suburban Home";
    ...
    const btnLabel = loc === 1 ? "NEXT LOCATION →" : "NEXT STAGE →";
